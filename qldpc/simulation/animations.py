        ...
        for j in range(m):
            for i in range(n):
                ...
                rect = Rectangle((i-0.4, j-0.4), 0.8, 0.8, 
                               facecolor=color, alpha=alpha, edgecolor='#aaaaaa')
                ax2.add_patch(rect)
        ...
        if phase >= 3:
            ...
            if iteration >= 4:
                ax3.text(7, -2.5, 'Decoding Complete!\nError Pattern Estimated', 
                        ha='center', fontsize=12, color='#00cc66', fontweight='bold',
...
def create_threshold_behavior_animation():
    ...
    def animate(frame):
        ...
        ax1.loglog(p_range, p_range, color='#888888', linestyle=':', alpha=0.5, linewidth=1.5, 

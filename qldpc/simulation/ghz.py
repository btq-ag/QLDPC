...
def create_ghz_fidelity_analysis():
    ...
    ax2.axhline(y=100, color='#ff9f43', linestyle=':', linewidth=2, alpha=0.7,
...
def create_ghz_preparation_protocol():
    ...
    # Draw cavity
    cavity_rect = Rectangle((0.5, 1), 9, 4, fill=False, edgecolor='#aaaaaa', 
    ...
    for i in range(1, n_atoms):
        ax.plot([atom_positions[0], atom_positions[i]], [3.4, 3.4], color='#ff6b6b', linewidth=2, alpha=0.7)
    ...
    ax.text(5, 4.5, 'Simultaneous Z-basis Measurements', ha='center', va='center', 
           fontsize=12, fontweight='bold', color='#5dade2')
    ...
    for i in range(n_atoms-1):
        for j in range(i+1, n_atoms):
            ax.plot([atom_positions[i], atom_positions[j]], [3.8, 3.8], color='#00cc66', linewidth=1, alpha=0.4)
    ...
    ax.text(5, 0.5, f'Fidelity: F = {0.95:.2f}', ha='center', va='center', 
           fontsize=12, color='#00cc66', fontweight='bold')
...
def create_ghz_scaling_analysis():
    ...
    ax2.plot(n_qubits, success_prob_ideal, '--', color='#999999', linewidth=2, 

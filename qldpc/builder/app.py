...
class TutorialScreen:
        ...
        return [
            # Step 0: Welcome
            {
                ...
                "content": [
                    ...
                    ("!\n\n", "normal"),
                    (
                        "This interactive tool lets you build and simulate quantum circuits ",
                        "normal",
                    ),
                    (
    ...
    def show(self):
        ...
        self.step_label = tk.Label(
            self.header_frame, text="", font=("Segoe UI", 10), fg="#888888", bg="#16213e"
        )
    ...
    def _place_demo_components(self, specs):
        ...
        for comp_type, position in specs:
            ...
            comp = Component3D(component_type=comp_type, position=position, color=color, size=size)
    ...
    def _demo_controlled_gate(self):
        ...
        self.circuit_builder._redraw_circuit()
        self.circuit_builder._log_status(
            "Demo: CH gate with control spanning 3 qubits (●──────gate)"
        )
    ...
    def _place_hint_components(self):
        ...
        for comp_type, position in hint_specs:
            ...
            if not occupied:
                ...
                component = Component3D(
                    component_type=comp_type, position=position, color=color, size=size
                )
        ...
        self.circuit_builder._redraw_circuit()
        self.circuit_builder._log_status(
            "Hint: Example LDPC circuit placed (3 data qubits + 2 parity checks + X gate)"
        )
...
class SurfaceCodeTutorialScreen:
    ...
    def _demo_error_detection(self):
        ...
        self._place_surface_demo_components(surface_specs)
        self.circuit_builder._log_status(
            "X-error at (3,3) → both adjacent Z-stabilizers detect it!"
        )
    ...
    def _demo_code_distance(self):
        ...
        self._place_surface_demo_components(surface_specs)
        self.circuit_builder._log_status(
            "Distance 3: Need 3 errors to create undetectable logical error"
        )
    ...
    def _place_surface_demo_components(self, specs: list[tuple]):
        ...
        for comp_type, position in specs:
            ...
            if not occupied:
                color = self.circuit_builder._get_component_color(comp_type)
                component = Component3D(
                    component_type=comp_type, position=(x, y, z), color=color, size=(1.0, 1.0, 1.0)
                )
                self.circuit_builder.components.append(component)
    ...
    def _demo_load_error_circuit(self):
        ...
        self._place_surface_demo_components(surface_specs)
        self.circuit_builder._log_status(
            "Error chain demo loaded! Try 'Highlight Syndrome' to see detection."
        )
    ...
    def _close_tutorial(self):
        ...
        if self.circuit_builder:
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Surface Code tutorial closed. Press V to switch back to circuit mode."
            )
...
class AdvancedLargeCircuitsTutorial:
        ...
        return [
            {
                ...
                "content": [
                    ...
                    ("2. ", "normal"),
                    ("Superdense Coding", "quantum"),
                    (" - 2 bits via 1 qubit\n", "normal"),
                    ("3. ", "normal"),
                    ("GHZ State", "quantum"),
                    (" - Multi-qubit entanglement\n", "normal"),
                    ("4. ", "normal"),
                    ("Quantum Fourier Transform", "ldpc"),
                    (" - 3-qubit QFT\n", "normal"),
                    ("5. ", "normal"),
                    ("Grover's Search", "ldpc"),
                    (" - 2-qubit oracle search\n", "normal"),
                    ("6. ", "normal"),
                    ("Deutsch-Jozsa", "action"),
                    (" - Quantum parallelism\n", "normal"),
                    ("7. ", "normal"),
                    ("Entanglement Swapping", "action"),
                    (" - Teleport entanglement\n", "normal"),
                    ("8. ", "normal"),
                    ("Shor's 9-Qubit Encoder", "highlight"),
                    (" - Full QEC circuit\n\n", "normal"),
                    ("💡 ", "warning"),
            ...
            },
            {
                ...
                "content": [
                    ...
                    (" - Quantum speedup\n", "normal"),
                    ("✓ ", "action"),
                    ("Entanglement Swap", "action"),
                    (" - Quantum repeaters\n", "normal"),
                    ("✓ ", "action"),
                    ("Shor's Code", "highlight"),
                    (" - Full QEC encoder\n\n", "normal"),
                    ("Next Steps:\n", "warning"),
    ...
    def show(self):
        ...
        # Step indicator
        self.step_label = tk.Label(
            self.header_frame, text="", font=("Segoe UI", 9), fg="#888888", bg="#2a1a3e"
        )
    ...
    def _execute_demo(self, action):
        ...
        if action == "intro":
            ...
            self.circuit_builder._log_status(
                "Advanced Tutorial: 8 large practical quantum circuits (grid=35)"
            )
            ...
            for i, y_pos in enumerate([-3, 0, 3]):
                self.circuit_builder.components.append(
                    Component3D(
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(-5, 0, 0), color=(1.0, 0.85, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(2, -3, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(4, -3, 0), color=(0.9, 0.1, 0.1)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(4, 0, 0), color=(0.9, 0.1, 0.1)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.X_GATE, position=(7, 3, 0), color=(0.9, 0.2, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.Z_GATE, position=(9, 3, 0), color=(0.2, 0.2, 0.9)
                )
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Teleportation: Bell pair + Bell measurement + conditional corrections"
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.X_GATE, position=(-1, -2, 0), color=(0.9, 0.2, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.Z_GATE, position=(1, -2, 0), color=(0.2, 0.2, 0.9)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(6, -2, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(8, -2, 0), color=(0.9, 0.1, 0.1)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Superdense: Bell pair + Alice encode (XZ=11) + Bob decode"
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(2, 0, 0), color=(1.0, 0.85, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(7, 3, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(-7, 2, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(-1, 2, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.X_GATE, position=(5, -2, 0), color=(0.9, 0.2, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(10, 2, 0), color=(0.9, 0.1, 0.1)
                )
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Grover's (2-qubit): H + Oracle(CZ) + Diffusion → finds |11⟩"
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.X_GATE, position=(-6, 3, 0), color=(0.9, 0.2, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(4, -3, 0), color=(1.0, 0.85, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(4, 0, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(7, -3, 0), color=(0.9, 0.1, 0.1)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(7, 0, 0), color=(0.9, 0.1, 0.1)
                )
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Deutsch-Jozsa: balanced oracle (XOR) → measure non-zero"
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(-6, 1, 0), color=(1.0, 0.85, 0.2)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.H_GATE, position=(1, -1, 0), color=(1.0, 0.85, 0.2)
                )
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.MEASURE, position=(3, -1, 0), color=(0.9, 0.1, 0.1)
                )
            )
            self.circuit_builder.components.append(
                Component3D(
            ...
            self.circuit_builder.components.append(
                Component3D(
                    component_type=ComponentType.Z_GATE, position=(8, 3, 0), color=(0.2, 0.2, 0.9)
                )
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Entanglement Swap: 2 Bell pairs + BSM → q0-q3 entangled!"
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Shor's [[9,1,3]]: phase-flip + bit-flip concatenation"
            )
...
class SurfaceCodeTutorial:
        ...
        return [
            {
                ...
                "content": [
                    ...
                    ("We will cover:\n\n", "normal"),
                    ("1. ", "normal"),
                    ("Code Anatomy", "surface"),
                    (" - Data qubits & stabilizers\n", "normal"),
                    ("2. ", "normal"),
                    ("X Error Detection", "x_stab"),
                    (" - Z-stabilizer syndrome\n", "normal"),
                    ("3. ", "normal"),
                    ("Z Error Detection", "z_stab"),
                    (" - X-stabilizer syndrome\n", "normal"),
                    ("4. ", "normal"),
                    ("Error Chains", "error"),
                    (" - Multi-error patterns\n", "normal"),
                    ("5. ", "normal"),
                    ("Syndrome Highlight", "warning"),
                    (" - Yellow button demo\n", "normal"),
                    ("6. ", "normal"),
            ...
            },
            {
                ...
                "content": [
                    ...
                    ("• ", "data"),
                    ("Data Qubits", "data"),
                    (" (cyan circles) - Store quantum info\n", "normal"),
                    ("• ", "x_stab"),
                    ("X-Stabilizers", "x_stab"),
                    (" (red) - Detect Z errors\n", "normal"),
                    ("• ", "z_stab"),
                    ("Z-Stabilizers", "z_stab"),
                    (" (purple) - Detect X errors\n\n", "normal"),
                    ("Parameters:\n", "math"),
            ...
            },
            {
                ...
                "content": [
                    ...
                    ("Yellow QEC Buttons:\n", "warning"),
                    ("• ", "correct"),
                    ("Highlight Syndrome", "correct"),
                    (" - Shows violated stabilizers\n", "normal"),
                    ("• ", "correct"),
                    ("Run Decoder", "correct"),
                    (" - Runs MWPM matching algorithm\n", "normal"),
                    ("• ", "correct"),
                    ("Apply Correction", "correct"),
                    (" - Places recovery gates\n", "normal"),
                    ("• ", "correct"),
                    ("Clear Highlights", "correct"),
                    (" - Resets syndrome display\n\n", "normal"),
                    ("Errors Tab (Toolbox):\n", "action"),
            ...
            },
            {
                ...
                "content": [
                    ...
                    ("1. ", "action"),
                    ("Initialize", "action"),
                    (" - Prepare logical |0⟩ or |+⟩\n", "normal"),
                    ("2. ", "action"),
                    ("Gate Operations", "action"),
                    (" - Apply logical gates\n", "normal"),
                    ("3. ", "action"),
                    ("Error Occurs", "error"),
                    (" - Physical errors on data\n", "normal"),
                    ("4. ", "action"),
                    ("Syndrome Measure", "correct"),
                    (" - Extract stabilizer values\n", "normal"),
                    ("5. ", "action"),
                    ("Decode", "surface"),
                    (" - MWPM identifies error chain\n", "normal"),
                    ("6. ", "action"),
                    ("Correct", "correct"),
            ...
            },
            {
                ...
                "content": [
                    ...
                    ("✓ ", "action"),
                    ("Code Anatomy", "surface"),
                    (" - Data, X/Z stabilizers\n", "normal"),
                    ("✓ ", "action"),
                    ("Error Detection", "x_stab"),
                    (" - Anti-commutation syndrome\n", "normal"),
                    ("✓ ", "action"),
                    ("Error Chains", "error"),
                    (" - Multi-qubit patterns\n", "normal"),
                    ("✓ ", "action"),
                    ("Syndrome Analysis", "correct"),
    ...
    def show(self):
        ...
        self.step_label = tk.Label(
            self.header_frame, text="", font=("Segoe UI", 9), fg="#888888", bg="#1a3a3e"
        )
        self.step_label.pack(pady=(0, 8))
    ...
    def _execute_demo(self, action):
        ...
        if action == "intro":
            ...
            self.circuit_builder._draw_grid()
            self.circuit_builder._log_status(
                "Surface Code Tutorial: 2D lattice mode for QEC visualization"
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Surface code d=3: 9 data (cyan), 4 X-stab (red), 8 Z-stab (purple)"
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "X error on center qubit (3,3) - adjacent Z-stabilizers detect it!"
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Z error on qubit (3,1) - adjacent X-stabilizers detect it!"
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Error chain: 2 X errors at (1,3) and (3,3) - syndrome at endpoints only!"
            )
            ...
            if hasattr(self.circuit_builder, "_highlight_surface_syndrome"):
                ...
                self.circuit_builder._log_status(
                    "Syndrome highlighted! Yellow shows violated stabilizers."
                )
            else:
                self.circuit_builder._log_status(
                    "Click yellow 'Highlight Syndrome' button to see violations."
                )
            ...
            self.circuit_builder._switch_to_surface_mode()
            self.circuit_builder._log_status(
                "Surface Mode Buttons: Highlight Syndrome, Run Decoder, Apply Correction, Clear Highlights"
            )
            ...
            self.circuit_builder.components.append(
                Component3D(
                    ...
                    position=(1, 5, 0),
                    color=(1.0, 0.85, 0.2),  # Yellow for Y
                )
            )
            ...
            self.circuit_builder._redraw_circuit()
            self.circuit_builder._log_status(
                "Full cycle: X error at (3,3), Y error at (1,5). Try syndrome highlight!"
            )

        elif action == "complete":
            self.circuit_builder._log_status(
                "Surface Code tutorial complete! Use the yellow buttons for QEC operations."
            )
...
# Import shared types from package modules (avoiding duplication)
...
class CircuitBuilder3D:
    ...
    def _setup_ui(self):
        ...
        self.canvas = tk.Canvas(
            canvas_frame, bg="#1e1e1e", highlightthickness=1, highlightbackground="#404040"
        )
        ...
        self.right_canvas = tk.Canvas(
            right_outer_frame, bg="#2b2b2b", highlightthickness=0, width=280
        )
        self.right_scrollbar = ttk.Scrollbar(
            right_outer_frame, orient=tk.VERTICAL, command=self.right_canvas.yview
        )
        ...
        self.right_canvas_window = self.right_canvas.create_window(
            (0, 0), window=self.right_frame, anchor="nw", width=280
        )
        ...
        self.right_canvas.bind(
            "<MouseWheel>",
            lambda e: self.right_canvas.yview_scroll(int(-1 * (e.delta / 120)), "units"),
        )
    ...
    def _create_toolbox_notebook(self):
        ...
        if self.view_mode == ViewMode.SURFACE_CODE_2D:
            ...
            categories = {
                "Single": [
                    ComponentType.X_GATE,
                    ComponentType.Z_GATE,
                    ComponentType.Y_GATE,
                    ComponentType.H_GATE,
                    ComponentType.S_GATE,
                    ComponentType.T_GATE,
                ],
                "Double": [ComponentType.CNOT_GATE, ComponentType.CZ_GATE, ComponentType.SWAP_GATE],
                "Qubits": [ComponentType.DATA_QUBIT, ComponentType.ANCILLA_QUBIT],
                "Measure": [ComponentType.MEASURE, ComponentType.RESET],
                "Errors": [
                    ComponentType.CIRCUIT_X_ERROR,
                    ComponentType.CIRCUIT_Z_ERROR,
        ...
        for category, components in categories.items():
            ...
            for i, comp_type in enumerate(components):
                ...
                if comp_type in controllable_gates:
                    btn.bind(
                        "<Button-3>", lambda e, ct=comp_type: self._show_toolbox_context_menu(e, ct)
                    )
    ...
    def _setup_controls(self, parent):
        ...
        self.circuit_mode_btn = tk.Button(
            mode_frame,
            text="Circuit Mode",
        ...
        self.surface_mode_btn = tk.Button(
            mode_frame,
            text="Surface Code (V)",
        ...
        self.ldpc_submode_btn = tk.Button(
            mode_frame,
            text="→ Tanner Graph",
    ...
    def _create_circuit_mode_buttons(self):
        ...
        # Mode header
        header = tk.Label(
            self.circuit_mode_frame,
            text="Circuit Operations",
            bg="#2b2b2b",
            fg="#aabbcc",
            font=("TkDefaultFont", 9, "bold"),
        )
        ...
        ttk.Button(
            ...
            command=self._simulate_evolution,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)

        ttk.Button(
            self.circuit_mode_frame,
            text="Calculate Syndrome",
            command=self._calculate_syndrome,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)

        ttk.Button(
            self.circuit_mode_frame,
            text="Validate Circuit",
            command=self._validate_circuit,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        error_info = tk.Label(
            self.circuit_mode_frame,
            text="Place errors from Errors tab",
            bg="#2b2b2b",
            fg="#888888",
            font=("TkDefaultFont", 8),
        )
        ...
        self.circuit_correct_btn = tk.Button(
            self.circuit_mode_frame,
    ...
    def _create_surface_mode_buttons(self):
        ...
        # Mode header
        header = tk.Label(
            self.surface_mode_frame,
            text="Surface Code Operations",
            bg="#2b2b2b",
            fg="#aabbcc",
            font=("TkDefaultFont", 9, "bold"),
        )
        ...
        error_info = tk.Label(
            self.surface_mode_frame,
            text="Place errors using toolbox",
            bg="#2b2b2b",
            fg="#888888",
            font=("TkDefaultFont", 8),
        )
        ...
        ttk.Button(
            self.surface_mode_frame,
            text="Highlight Syndrome",
            command=self._highlight_syndrome_surface,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        ttk.Button(
            self.surface_mode_frame,
            text="Run Decoder",
            command=self._run_decoder_surface,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)

        # Correction button (yellow accent)
        self.surface_correct_btn = tk.Button(
            self.surface_mode_frame,
            text="Apply Correction",
        ...
        ttk.Button(
            ...
            command=self._clear_syndrome_highlights,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        self.surface_syndrome_label = tk.Label(
            self.surface_info_frame,
            text="Errors: 0  |  Syndrome: 0",
            bg="#2b2b2b",
            fg="#88ff88",
            font=("Consolas", 8),
        )
        ...
        self.surface_threshold_label = tk.Label(
            self.surface_info_frame,
            text="Threshold: OK",
            bg="#2b2b2b",
            fg="#88ff88",
    ...
    def _create_ldpc_mode_buttons(self):
        ...
        self.ldpc_submode_label = tk.Label(
            self.ldpc_mode_frame,
        ...
        ttk.Button(
            ...
            command=self._show_ldpc_connectivity,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        ttk.Button(
            self.ldpc_mode_frame,
            text="Clear Graph",
            command=self._clear_ldpc_graph,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        ttk.Button(
            ...
            command=self._generate_ldpc_example,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        self.ldpc_syndrome_btn = tk.Button(
            self.ldpc_mode_frame,
    ...
    def _setup_help(self, parent):
        ...
        tk.Button(
            self.circuit_tutorial_row,
            text="Basic",
            command=self._show_tutorial,
            bg="#3a5a6a",
            fg="#88ccdd",
            activebackground="#5a7a8a",
            activeforeground="#ffffff",
            relief="flat",
            pady=3,
            font=("TkDefaultFont", 8, "bold"),
        ...
        tk.Button(
            self.surface_tutorial_row,
            text="📖 Surface Code Tutorial",
            command=self._show_surface_code_tutorial,
            bg="#4a6a4a",
            fg="#88dd88",
            activebackground="#6a8a6a",
            activeforeground="#ffffff",
            relief="flat",
            pady=3,
            font=("TkDefaultFont", 8, "bold"),
        ...
        tk.Button(
            self.ldpc_tutorial_row,
            text="📖 LDPC Tutorial",
            command=self._show_ldpc_tutorial,
            bg="#5a4a6a",
            fg="#cc99dd",
            activebackground="#7a6a8a",
            activeforeground="#ffffff",
            relief="flat",
            pady=3,
            font=("TkDefaultFont", 8, "bold"),
        ...
        ttk.Button(
            ...
            command=self._show_quick_reference,
            style="Dark.TButton",
        ).pack(fill=tk.X, padx=5, pady=1)
        ...
        ttk.Button(
            self.help_frame, text="Legend", command=self._toggle_legend, style="Dark.TButton"
        ).pack(fill=tk.X, padx=5, pady=1)
    ...
    def _show_shortcuts(self):
        ...
        for category, shortcuts in shortcut_categories.items():
            ...
            for key, description in shortcuts:
                ...
                # Description
                desc_label = tk.Label(
                    row_frame, text=description, bg="#2b2b2b", fg="#cccccc", font=("Segoe UI", 9)
                )
    ...
    def _setup_status_bottom(self, parent):
        ...
        tk.Label(
            bottom_frame, text="|", bg="#2b2b2b", fg="#555555", font=("TkDefaultFont", 10)
    ...
    def _setup_status(self, parent):
        ...
        title_label = ttk.Label(
            title_container, text="Current Circuit:", style="Dark.TLabel", font=("TkDefaultFont", 8)
        )
        title_label.pack(anchor=tk.W, padx=5)

        self.circuit_title_label = ttk.Label(
            title_container,
            text="New Circuit",
            style="Dark.TLabel",
            font=("TkDefaultFont", 10, "bold"),
    ...
    def _toggle_view_mode(self, event=None):
        ...
        if (
            hasattr(self, "legend_window")
            and self.legend_window
            and self.legend_window.winfo_exists()
        ):
    ...
    def _draw_isometric_grid(self):
        ...
        for i in range(-grid_range, grid_range + 1):
            for j in range(-grid_range, grid_range + 1):
                ...
                is_boundary = (
                    i == -grid_range or i == grid_range or j == -grid_range or j == grid_range
                )
    ...
    def _draw_surface_code_lattice(self):
            ...
            for j in range(-1, lattice_extent + 2):
                if (i + j) % 2 == 0:  # Data qubit positions (odd coords = even sum)
                    ...
                    self.canvas.create_line(
                        x - 3, y, x + 3, y, fill=grid_line_color, width=1, tags="grid"
                    )
                    self.canvas.create_line(
                        x, y - 3, x, y + 3, fill=grid_line_color, width=1, tags="grid"
                    )
        ...
        for sx, sy in z_stabilizer_positions:
            for dx, dy in [(1, 1), (1, -1), (-1, 1), (-1, -1)]:
                nx, ny = sx + dx, sy + dy
                if (nx, ny) in data_positions or (
                    0 < nx < lattice_extent and 0 < ny < lattice_extent
                ):
        ...
        for x, y in data_positions:
            ...
            self.canvas.create_oval(
                ...
                sx + r,
                sy + r,
                fill=data_qubit_color,
                outline="#aaaaaa",
                width=2,
                tags="grid data_qubit",
            )
        ...
        for x, y in x_stabilizer_positions:
            ...
            self.canvas.create_polygon(
                points, fill="", outline=x_stab_color, width=2, tags="grid x_stab"
            )
            # No label for background elements - too cluttered
        ...
        for i in range(0, lattice_extent + 1, 2):
            ...
            self.canvas.create_text(
                sx, sy + 25, text=str(i), fill="#666666", font=("Arial", 9), tags="grid"
            )
            sx, sy = to_screen(0, i)
            self.canvas.create_text(
                sx - 25, sy, text=str(i), fill="#666666", font=("Arial", 9), tags="grid"
            )
    ...
    def _draw_placed_surface_components(self):
        ...
        for comp in self.components:
            ...
            if comp.component_type == ComponentType.SURFACE_X_STABILIZER:
                ...
                self.canvas.create_polygon(
                    points, fill=color, outline="#ffffff", width=3, tags="component"
                )
                self.canvas.create_text(
                    screen_x,
                    screen_y,
            ...
            for d_pos in data_positions:
                ...
                if d_row == x_row:  # Same row
                    ...
                    if col_distance <= 3:  # Connect to nearby data qubits with arcs
                        ...
                        self._draw_hgp_arc(
                            cx, cy, dx, dy, colors["x_check"], direction="horizontal", alpha=0.35
                        )
            ...
            for d_pos in data_positions:
                ...
                if d_col == z_col:  # Same column
                    ...
                    if row_distance <= 2:  # Connect with arcs
                        ...
                        self._draw_hgp_arc(
                            cx, cy, dx, dy, colors["z_check"], direction="vertical", alpha=0.35
                        )
    ...
    def _draw_hgp_arc(
        self, x1, y1, x2, y2, color, direction="horizontal", alpha=0.4, long_range=False
    ):
        ...
        self.canvas.create_line(
            *points, fill=blended_color, width=width, smooth=True, tags="grid hgp_arc"
        )
    ...
    def _draw_curved_edge(self, x1, y1, x2, y2, color, alpha=0.5, curve_direction="down"):
        ...
        self.canvas.create_line(
            *points, fill=blended_color, width=2, smooth=True, tags="grid ldpc_edge"
        )
    ...
    def _draw_ldpc_physical_lattice(self):
        ...
        for y, color in [
            (y_z_ancilla, colors["z_ancilla"]),
            (y_data, colors["data_qubit"]),
            (y_x_ancilla, colors["x_ancilla"]),
        ]:
            # Main wire
            self.canvas.create_line(
                wire_start_x, y, wire_end_x, y, fill=color, width=3, tags="grid"
            )
        ...
        for bus_idx in bus_positions:
            ...
            self.canvas.create_rectangle(
                ...
                bus_x + bus_width,
                y_x_ancilla + 30,
                fill=colors["cavity_bus"],
                outline=colors["cavity_bus"],
                width=0,
                tags="grid ldpc_bus",
            )
    ...
    def _draw_cavity_path(self, x1, y1, x2, y2, cavity_x, color):
        ...
        self.canvas.create_line(
            *points, fill=color, width=2, smooth=True, dash=(4, 2), tags="grid ldpc_cavity_path"
        )
    ...
    def _on_surface_code_click(self, event):
        ...
        if (
            lattice_x < 0
            or lattice_x > lattice_extent
            or lattice_y < 0
            or lattice_y > lattice_extent
        ):
        ...
        if self.current_tool in edge_types:
            ...
            snapped_x = (
                nearest_x
                if nearest_x % 2 == 1
                else (nearest_x + 1 if lattice_x > nearest_x else nearest_x - 1)
            )
            snapped_y = (
                nearest_y
                if nearest_y % 2 == 1
                else (nearest_y + 1 if lattice_y > nearest_y else nearest_y - 1)
            )
    ...
    def _place_surface_component(self, comp_type: ComponentType, lattice_x, lattice_y):
        ...
        for comp in self.components:
            if abs(comp.position[0] - snapped_x) < 0.5 and abs(comp.position[1] - snapped_y) < 0.5:
        ...
        new_component = Component3D(
            component_type=comp_type, position=(snapped_x, snapped_y, 0), color=color
        )
    ...
    def _on_canvas_drag(self, event):
        ...
        if self.dragging and self.drag_component:
            ...
            if grid_x < grid_min or grid_x > grid_max or grid_y < grid_min or grid_y > grid_max:
    ...
    def _screen_to_grid(self, screen_x: float, screen_y: float) -> tuple[int, int]:
        ...
        grid_x = round(
            (
                relative_x / self.renderer.scale / self.renderer.cos_30
                + relative_y / self.renderer.scale / self.renderer.sin_30
            )
            / 2
        )
        grid_y = round(
    ...
    def _place_component(self, grid_x: int, grid_y: int, grid_z: int):
        ...
        if grid_x < grid_min or grid_x > grid_max or grid_y < grid_min or grid_y > grid_max:
            self._log_status(
                f"Cannot place component outside grid boundaries ({grid_min} to {grid_max})"
            )
            return
        ...
        if is_two_qubit:
            ...
            if self._get_component_at_position(grid_x, target_lane):
                self._log_status(
                    f"Two-qubit gate needs target lane ({grid_x}, {target_lane}) to be free!"
                )
                return
            if target_lane > grid_max:
                self._log_status("Two-qubit gate target lane would be outside grid boundaries!")
                return
    ...
    def _redraw_circuit(self) -> None:
        ...
        sorted_components = sorted(
            self.components, key=lambda c: (c.position[0] + c.position[1], c.position[2])
        )
        ...
        for component in sorted_components:
            ...
            if component.component_type in two_qubit_types:
                ...
                # Control position (●)
                ctrl_x, ctrl_y_2d = self.renderer.project_3d_to_2d(
                    x + w / 2, control_y + 0.5, z + h / 2
                )
                # Target position (⊕)
                tgt_x, tgt_y_2d = self.renderer.project_3d_to_2d(
                    x + w / 2, target_y + 0.5, z + h / 2
                )

                # Draw connecting line
                self.canvas.create_line(
                    ctrl_x, ctrl_y_2d, tgt_x, tgt_y_2d, fill="#ffffff", width=2, tags="component"
                )
    ...
    def _show_context_menu(self, event, component: Component3D):
        ...
        if component.component_type in controllable_gates:
            ...
            if component.properties.get("is_controlled"):
                context_menu.add_command(
                    label="✓ Remove Control", command=lambda: self._remove_control(component)
                )
            else:
                context_menu.add_command(
                    label="● Add Control",
        ...
        context_menu.add_command(label="Rotate", command=lambda: self._rotate_component(component))
        context_menu.add_command(
            label="Duplicate", command=lambda: self._duplicate_component(component)
        )
        context_menu.add_command(label="Delete", command=lambda: self._delete_component(component))
        context_menu.add_separator()
        context_menu.add_command(
            label="Properties", command=lambda: self._show_properties(component)
        )
    ...
    def _start_add_control_mode(self, component: Component3D, event):
        ...
        self._log_status(
            f"🎯 Click on a qubit lane to place control for {component.component_type.value}"
        )
    ...
    def _preview_control_line_motion(self, event):
        ...
        self._preview_control_line = self.canvas.create_line(
            gate_x, gate_y, event.x, event.y, fill="#00ff00", width=2, dash=(4, 4), tags="preview"
        )
    ...
    def _show_toolbox_context_menu(self, event, comp_type: ComponentType):
        ...
        context_menu.add_command(
            label=f"Place {comp_type.value}", command=lambda: self._select_tool(comp_type)
        )
    ...
    def _start_controlled_gate_placement(self, comp_type: ComponentType):
        ...
        self._log_status(
            f"🎯 Click to place C{comp_type.value} target gate, then click control position"
        )
        self.canvas.config(cursor="crosshair")
    ...
    def _place_controlled_gate_base(self, event):
        ...
        new_component = Component3D(
            component_type=comp_type, position=(grid_x, grid_y, 0), color=color, properties={}
        )
        self.components.append(new_component)
        self._log_status(
            f"Placed {comp_type.value} at ({grid_x}, {grid_y}) - now click control position"
        )
    ...
    def _duplicate_component(self, component: Component3D):
        ...
        for new_x, new_y, new_z in adjacent_positions:
            ...
            if not self._get_component_at_position(new_x, new_y):
                ...
                self.components.append(new_component)
                self._log_status(
                    f"Duplicated {component.component_type.value} at ({new_x}, {new_y}, {new_z})"
                )
                self._redraw_circuit()
                return
    ...
    def _copy_all_selected(self, event=None):
        ...
        circuit_data = {
            ...
            if hasattr(self.view_mode, "value")
            else str(self.view_mode),
            "components": [
                {
    ...
    def _show_properties(self, component: Component3D):
        ...
        # Component info
        ttk.Label(
            props_frame, text=f"Type: {component.component_type.value}", style="Dark.TLabel"
        ).pack(anchor=tk.W, pady=2)
        ttk.Label(props_frame, text=f"Position: {component.position}", style="Dark.TLabel").pack(
            anchor=tk.W, pady=2
        )
        ttk.Label(props_frame, text=f"Rotation: {component.rotation}°", style="Dark.TLabel").pack(
            anchor=tk.W, pady=2
        )
        ttk.Label(props_frame, text=f"Size: {component.size}", style="Dark.TLabel").pack(
            anchor=tk.W, pady=2
        )
        ...
        if component.properties:
            ...
            ttk.Label(props_frame, text="Custom Properties:", style="Dark.TLabel").pack(
                anchor=tk.W, pady=2
            )

            for key, value in component.properties.items():
                ttk.Label(props_frame, text=f"{key}: {value}", style="Dark.TLabel").pack(
                    anchor=tk.W, pady=1
                )
        ...
        if filename:
            try:
                ...
                messagebox.showerror(
                    error_info["title"], ErrorContext.format_error_dialog(error_info)
                )
    ...
    def _load_circuit(self):
        ...
        # saved_circuits/ lives at repo root (two levels up from qldpc/builder/)
        ...
        if filename:
            try:
                ...
                if validation_result["warnings"]:
                    self._log_status(
                        f"⚠ {len(validation_result['warnings'])} warning(s) in circuit file"
                    )
    ...
    def _load_circuit_from_path(self, filepath: str):
        ...
        try:
            ...
            if skipped_count > 0:
                self._log_status(
                    f"⚠ Skipped {skipped_count} unknown component(s): {', '.join(skipped_types)}"
                )
    ...
    def _calculate_syndrome(self):
        ...
        try:
            ...
            if len(syndrome) > 0:
                ...
                data_qubits = len(
                    [c for c in self.components if c.component_type == ComponentType.DATA_QUBIT]
                )
                ancilla_qubits = len(
                    [c for c in self.components if c.component_type == ComponentType.ANCILLA_QUBIT]
                )
                parity_checks = len(
                    [c for c in self.components if c.component_type == ComponentType.PARITY_CHECK]
                )

                self._log_status("=== Syndrome Calculation ===")
                self._log_status(
                    f"Data qubits: {data_qubits}, Ancilla qubits: {ancilla_qubits}, Parity checks: {parity_checks}"
                )
                ...
                self._log_status(
                    "No syndrome extractors found. Need ancilla qubits or parity check components."
                )
    ...
    def _apply_circuit_correction(self):
        ...
        for error in errors:
            ...
            correction = Component3D(
                ...
                connections=[],
                properties={
                    "correction_for": error.component_type.value,
    ...
    def _run_error_correction(self):
        ...
        try:
            ...
            if len(syndrome) == 0:
                self._log_status(
                    "No syndrome available for error correction. Need ancilla qubits or parity checks."
                )
                return
            ...
            if result["success"]:
                ...
                self._log_status("=== Error Correction Results ===")
                self._log_status(f"Converged in {iterations} iterations")
                self._log_status(
                    f"Data qubits: {num_data_qubits}, Syndrome weight: {syndrome_weight}"
                )
    ...
    def _perform_circuit_validation(self) -> dict:
        ...
        qubits = [
            ...
            if c.component_type
            in [ComponentType.QUBIT, ComponentType.DATA_QUBIT, ComponentType.ANCILLA_QUBIT]
        ]
        gates = [
            c
            for c in self.components
        ...
        connections = [
            c for c in self.components if c.component_type == ComponentType.QUBIT_CONNECTION
        ]
        syndrome_extractors = [
            c
            for c in self.components
            if c.component_type
            in [ComponentType.X_STABILIZER, ComponentType.Z_STABILIZER, ComponentType.PARITY_CHECK]
        ]
        ...
        two_qubit_gates = [
            ...
            for c in self.components
            if c.component_type
            in [ComponentType.CNOT_GATE, ComponentType.CZ_GATE, ComponentType.SWAP_GATE]
        ]
        ...
        for gate in two_qubit_gates:
            ...
            if not paired_found:
                ...
                conn_found = any(
                    c.component_type == ComponentType.QUBIT_CONNECTION
                    and abs(c.position[0] - x) <= 1
                    for c in connections
                )
                if not conn_found:
                    warnings.append(
                        f"Two-qubit gate {gate.component_type.value} at {gate.position} may need a connection"
                    )
        ...
        if measurements:
            ...
            if early_measurements:
                warnings.append(
                    f"Found {len(early_measurements)} measurement(s) before later gates - may cause issues"
                )
        ...
        if gates:
            ...
            if circuit_depth > 100:
                warnings.append(
                    f"Circuit depth ({circuit_depth}) is very high - may impact simulation performance"
                )
        ...
        if syndrome_extractors and len(qubits) > 0:
            for se in syndrome_extractors:
                ...
                nearby_qubits = [
                    q
                    for q in qubits
                    if abs(q.position[0] - x) <= 1
                    and abs(q.position[1] - y) <= 2
                    and abs(q.position[2] - z) <= 2
                ]
        ...
        if syndrome_extractors:
            info.append(
                f"Error correction ready with {len(syndrome_extractors)} syndrome extractor(s)"
            )
        if measurements:
    ...
    def _show_validation_results(self, results: dict):
        ...
        tk.Label(
            stats_frame, text=stats_text, bg="#2b2b2b", fg="#cccccc", font=("TkDefaultFont", 9)
        ).pack(padx=5, pady=5)
        ...
        if not errors and not warnings:
            text_widget.insert(
                tk.END, "No issues found! Circuit is ready for simulation.\n", "info"
            )
        ...
        ttk.Button(button_frame, text="Close", command=dialog.destroy, style="Dark.TButton").pack(
    ...
    def _inject_circuit_error(self, error_type: str):
        ...
        if (
            ...
            and self.selected_component.component_type == ComponentType.DATA_QUBIT
        ):
    ...
    def _apply_syndrome_based_correction(self):
        ...
        # Log the correction
        self._log_status("=== Correction Applied ===")
    ...
    def _apply_surface_correction(self):
        ...
        for error in errors:
            ...
            correction_op = (
                "X"
                if error_type == ComponentType.SURFACE_X_ERROR
                else "Z"
                if error_type == ComponentType.SURFACE_Z_ERROR
                else "Y"
            )
            self.canvas.create_text(
                canvas_x,
                canvas_y - radius - 8,
                text=f"Fix:{correction_op}",
                fill="#ffcc00",
        ...
        self._log_status("=== Surface Code Correction ===")
    ...
    def _update_surface_info(self):
        ...
        stabilizers = [
            ...
            for c in self.components
            if c.component_type
            in [ComponentType.SURFACE_X_STABILIZER, ComponentType.SURFACE_Z_STABILIZER]
        ]
        ...
        # Update labels
        if hasattr(self, "surface_syndrome_label"):
            self.surface_syndrome_label.config(
                text=f"Errors: {num_errors}  |  Stabs: {len(stabilizers)}"
            )
        ...
        if hasattr(self, "surface_threshold_label"):
            if num_errors == 0:
                ...
                self.surface_threshold_label.config(
                    text=f"Status: Correctable ({num_errors}/{max_correctable})", fg="#ffcc44"
                )
            else:
                self.surface_threshold_label.config(
                    text=f"Status: DANGER ({num_errors}>{max_correctable})", fg="#ff4444"
                )
    ...
    def _export_to_qasm(self):
        ...
        if not data_qubits and not ancilla_qubits:
            self._log_status(
                "No qubits in circuit. Add DATA_QUBIT or ANCILLA_QUBIT components first."
            )
        ...
        qasm_lines = [
            ...
            'include "qelib1.inc";',
            "",
            "// Circuit exported from Quantum LDPC Circuit Builder",
    ...
    def _highlight_syndrome_surface(self):
        ...
        try:
            ...
            if not errors:
                self._log_status(
                    "No errors placed. Add X, Z, or Y errors to see syndrome highlighting."
                )
                return
            ...
            for error in errors:
                ...
                for stab in stabilizers:
                    ...
                    if is_neighbor and stab_pos_key not in triggered_positions:
                        ...
                        if (
                            error_type == ComponentType.SURFACE_X_ERROR
                            and stab_type == ComponentType.SURFACE_Z_STABILIZER
                        ):
                            triggered_stabilizers.append(stab)
                            triggered_positions.add(stab_pos_key)
                        elif (
                            error_type == ComponentType.SURFACE_Z_ERROR
                            and stab_type == ComponentType.SURFACE_X_STABILIZER
                        ):
                            triggered_stabilizers.append(stab)
                            triggered_positions.add(stab_pos_key)
            ...
            for stab in triggered_stabilizers:
                ...
                color = (
                    "#ff0000"
                    if stab.component_type == ComponentType.SURFACE_Z_STABILIZER
                    else "#00ff00"
                )
            ...
            self._log_status("=== Syndrome Highlighting ===")
    ...
    def _run_decoder_surface(self):
        ...
        try:
                ...
                for stab in stabilizers:
                    ...
                    if is_neighbor:
                        if (
                            ...
                            if (
                                stab_type == ComponentType.SURFACE_Z_STABILIZER
                                and stab not in triggered_z_stabs
                            ):
                                triggered_z_stabs.append(stab)
                            elif (
                                stab_type == ComponentType.SURFACE_X_STABILIZER
                                and stab not in triggered_x_stabs
                            ):
                                triggered_x_stabs.append(stab)
                ...
                while len(remaining) >= 2:
                    ...
                    for i in range(len(remaining)):
                        for j in range(i + 1, len(remaining)):
                            ...
                            dist = abs(s1.position[0] - s2.position[0]) + abs(
            ...
            x_corrections = draw_correction_path(
                triggered_x_stabs, "#00ff88"
            )  # Green for X corrections
            z_corrections = draw_correction_path(
                triggered_z_stabs, "#ff8800"
            )  # Orange for Z corrections

            self._log_status("=== Decoder Results ===")
    ...
    def _show_ldpc_connectivity(self):
        ...
        if self.view_mode == ViewMode.LDPC_TANNER:
            ...
            self._redraw_circuit()
            self._log_status(
                "LDPC Tanner graph connectivity displayed. Check nodes connect to data qubits via curved edges."
            )
        elif self.view_mode == ViewMode.LDPC_PHYSICAL:
            ...
            self._redraw_circuit()
            self._log_status(
                "LDPC physical layout displayed. Cavity buses enable non-local interactions."
            )
        else:
    ...
    def _generate_ldpc_example(self):
        ...
        if self.view_mode == ViewMode.LDPC_TANNER:
            ...
            self._redraw_circuit()
            self._log_status(
                "Generated example LDPC Tanner graph with 4 X-checks, 8 data qubits, 4 Z-checks"
            )
    ...
    def _show_ldpc_syndrome(self):
        ...
        data_qubits = [
            c for c in self.components if c.component_type == ComponentType.LDPC_DATA_QUBIT
        ]
        ...
        if highlighted_checks:
            self._log_status(
                f"⚠ Parity violations detected at {len(highlighted_checks)} check nodes"
            )
            self._log_status(
                f"  Violated checks: {', '.join(highlighted_checks[:5])}{'...' if len(highlighted_checks) > 5 else ''}"
            )
        else:
    ...
    def _show_quick_reference(self):
        ...
        def add_section(title, items, color="#4fc3f7"):
            ...
            tk.Label(
                frame, text=title, font=("TkDefaultFont", 11, "bold"), bg="#2b2b2b", fg=color
            ).pack(anchor="w")
        ...
        ttk.Button(close_frame, text="Close", command=dialog.destroy, style="Dark.TButton").pack(
            side=tk.RIGHT
        )
    ...
    def _show_legend(self):
        ...
        title_label = tk.Label(
            main_frame, text=title_text, font=("Segoe UI", 14, "bold"), fg=title_color, bg="#1a1a2e"
        )
        ...
        scrollable_frame.bind(
            "<Configure>", lambda e: legend_canvas.configure(scrollregion=legend_canvas.bbox("all"))
        )
        ...
        if self.view_mode == ViewMode.SURFACE_CODE_2D:
            ...
            categories = {
                "Check Nodes": [ComponentType.LDPC_X_CHECK, ComponentType.LDPC_Z_CHECK],
                "Qubit Nodes": [ComponentType.LDPC_DATA_QUBIT, ComponentType.LDPC_ANCILLA],
                "Connections": [ComponentType.LDPC_EDGE],
            }
        elif self.view_mode == ViewMode.LDPC_PHYSICAL:
            # LDPC Physical layout mode
            categories = {
                "Data Qubits": [ComponentType.LDPC_DATA_QUBIT],
                "Ancilla Qubits": [
                    ComponentType.LDPC_X_ANCILLA,
                    ComponentType.LDPC_Z_ANCILLA,
                    ComponentType.LDPC_ANCILLA,
                ],
                "Cavity Bus": [ComponentType.LDPC_CAVITY_BUS],
            }
        else:
            ...
            categories = {
                ...
                "LDPC Components": [
                    ComponentType.PARITY_CHECK,
                    ComponentType.DATA_QUBIT,
                    ComponentType.ANCILLA_QUBIT,
                ],
                "Measurement": [ComponentType.MEASURE, ComponentType.RESET],
            }
    ...
    def _create_legend_item(self, parent, comp_type: ComponentType):
        ...
        preview_canvas = tk.Canvas(
            item_frame, width=canvas_width, height=40, bg="#0f0f23", highlightthickness=0
        )
        ...
        desc_label = tk.Label(
            text_frame, text=desc, font=("Segoe UI", 7), fg="#888888", bg="#0f0f23", anchor="w"
        )
    ...
    def _draw_mini_cube(self, canvas, cx, cy, color, depth=1.0):
        ...
        canvas.create_polygon(
            ...
            v[3][0],
            v[3][1],
            fill=to_hex(brighten(color, 0.5)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[6][0],
            v[6][1],
            fill=to_hex(brighten(color, 0.6)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[5][0],
            v[5][1],
            fill=to_hex(brighten(color, 0.55)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[4][0],
            v[4][1],
            fill=to_hex(brighten(color, 0.7)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[4][0],
            v[4][1],
            fill=to_hex(brighten(color, 0.85)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[7][0],
            v[7][1],
            fill=to_hex(brighten(color, 1.1)),
            outline=outline,
        )
    ...
    def _draw_mini_flat(self, canvas, cx, cy, color, comp_type: ComponentType):
        ...
        if comp_type == ComponentType.SURFACE_DATA:
            ...
            canvas.create_text(cx, cy, text="X", fill="#ffffff", font=("Arial", 10, "bold"))
            ...
            canvas.create_text(cx, cy, text="Z", fill="#ffffff", font=("Arial", 10, "bold"))
        elif comp_type == ComponentType.SURFACE_BOUNDARY:
            # Boundaries are thick lines
            canvas.create_line(cx - size, cy, cx + size, cy, fill=fill_color, width=4)
            canvas.create_line(cx - size, cy - 4, cx - size, cy + 4, fill=fill_color, width=2)
            canvas.create_line(cx + size, cy - 4, cx + size, cy + 4, fill=fill_color, width=2)
            ...
            canvas.create_text(cx, cy, text=gate_letter, fill="#ffffff", font=("Arial", 10, "bold"))
            ...
            canvas.create_oval(
                cx - size + 4, cy - 6, cx - 4, cy + 6, fill=fill_color, outline=outline, width=2
            )
            canvas.create_oval(
                cx + 4, cy - 6, cx + size - 4, cy + 6, fill=fill_color, outline=outline, width=2
            )
            ...
            canvas.create_text(cx, cy, text="0", fill="#ffffff", font=("Arial", 10, "bold"))
            ...
            canvas.create_text(cx, cy, text="Z", fill="#ffffff", font=("Arial", 9, "bold"))
            ...
            canvas.create_text(
                ...
                cy,
                text="Y",
                fill="#000000",  # Black text on yellow
                font=("Arial", 9, "bold"),
            )
        else:
    ...
    def run(self):
        ...
        self._log_status(
            "IMPROVEMENT: Grid boundaries enforced - components cannot be placed outside grid"
        )
        self._log_status(
            "IMPROVEMENT: Component stacking prevented - only one component per grid position"
        )

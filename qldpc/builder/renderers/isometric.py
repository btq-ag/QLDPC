...
class IsometricRenderer:
    ...
    def screen_to_grid(self, screen_x: float, screen_y: float) -> tuple[int, int]:
        ...
        grid_x = round(
            (relative_x / self.scale / self.cos_30 + relative_y / self.scale / self.sin_30) / 2
        )
        grid_y = round(
            (relative_y / self.scale / self.sin_30 - relative_x / self.scale / self.cos_30) / 2
        )
    ...
    def draw_mini_cube(
        ...
        canvas.create_polygon(
            ...
            v[3][0],
            v[3][1],
            fill=self._rgb_to_hex(self._brighten_color(color, 0.5)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[6][0],
            v[6][1],
            fill=self._rgb_to_hex(self._brighten_color(color, 0.6)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[5][0],
            v[5][1],
            fill=self._rgb_to_hex(self._brighten_color(color, 0.55)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[4][0],
            v[4][1],
            fill=self._rgb_to_hex(self._brighten_color(color, 0.7)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[4][0],
            v[4][1],
            fill=self._rgb_to_hex(self._brighten_color(color, 0.85)),
            outline=outline,
        )
        ...
        canvas.create_polygon(
            ...
            v[7][0],
            v[7][1],
            fill=self._rgb_to_hex(self._brighten_color(color, 1.1)),
            outline=outline,
        )
